    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('allpushnotifications')}}">Interest</a> </li>
            ...
            <div class="content-body">
                <form class="form-horizontal" id="formsss" method="post" action="{{route('cat_save')}}" name="specifycontent">
                    @csrf
