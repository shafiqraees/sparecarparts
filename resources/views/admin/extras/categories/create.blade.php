    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('cat_list')}}">Interest</a> </li>
                                <li class="breadcrumb-item active">Interest Create </li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                <form class="form-horizontal" id="formsss" method="post" action="{{route('cat_save')}}" name="specifycontent" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card box-shadow-0 border-dark">
                                    <div class="card-header card-head-inverse bg-dark">
                                        <h4 class="card-title text-white">Create Interest</h4>
                                    </div>
