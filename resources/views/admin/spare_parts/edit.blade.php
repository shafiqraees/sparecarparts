                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="car_id" id="select" required class="form-control">
                                                                ...
                                                                @foreach($car as $mod)
                                                                    <option value="{{$mod->id}}" {{ $data->car_id == $mod->id ? 'selected="selected"' : '' }}>{{$mod->title}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="number" name="price" value="{{$data->price}}" class="form-control" required data-validation-required-message="This field is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <h5>Description
