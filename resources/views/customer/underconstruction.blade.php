        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Under Construction</h3>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card box-shadow-0 border-dark">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <div class="p-1"> <img class="img-fluid" src="{{asset('public/app-assets/images/logo/underconstruction.jpg')}}" alt="branding logo"> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
